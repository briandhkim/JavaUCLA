...
public class Hw6Canvas extends JPanel{
	...
	private String xLabel = "";												// default for X label (empty)
	private String yLabel = "";												// default for Y label (empty)
	private String title = "";												// default for title (empty)
	...
	private int width = 400;				// width of plot in pixels
	private int height = 300;				// height of plot in pixels
	private int axisPad =1;				// padding between axes and edges of window
	...
	public void setDisplaySize(){
		...
		frame.repaint();										// probably could have just repainted the Plot - this.repaint()
	}
